/**
* This class draws the yellow star that is displayed on the winner panel.
* It draws the shape and fills it with color
* CPSC 224-01, Spring 2018
* Final Project - Race Through Space
* class DrawStarShape.java
...
public class DrawStarShape extends JPanel {
	...
	/**
	  * Sets up the size and layout for where the star is to be drawn
	  */
	...
	/**
	  * Fills the star with color and paints the star on the panel
	  */
	 ...
	 /**
	  * Create the star shapethe draws it as a path
